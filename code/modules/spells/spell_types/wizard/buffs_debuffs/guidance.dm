/obj/effect/proc_holder/spell/invoked/guidance
	...
	The spell applies to yourself and anyone next to you."
	cost = 1
	xp_gain = TRUE
	releasedrain = 60
	chargedrain = 1
...
/obj/effect/proc_holder/spell/invoked/guidance/cast(list/targets, mob/user)
	...
	user.visible_message("[user] mutters an incantation and a pulse of orange light radiates out from them.")
	for(var/mob/living/L in range(1, usr))
		L.apply_status_effect(/datum/status_effect/buff/guidance)
