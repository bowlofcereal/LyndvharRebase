...
/obj/structure/ascendant_altar/proc/ascend(mob/living/user)
	...
	switch(ascend_stage)
		...
		if(2)
			to_chat(user, span_danger("The second capstone. Stuck in filth- FILTH AND SHIT! I grab the rotted, fetted thing and begin to peel it back. LAYER BY LAYER- THE SUN TYRANT. THE ARCHDEVIL. IS SHE DEAD, OR SLEEPING? ..."))
			sleep(30)
