...
/datum/species/dracon
	...
	id = "dracon"
	desc = "<b>Drakian</b><br>\
	The Drakian are incredibly distinct from other races- save for the Zardmen. They harbor many traits of which could be seen in many depictions of “dragons”,  as a result of their direct servitude to Dragons themselves before their mysterious disappearance. When their masters vanished, they themselves became the masters. Greedy and mysterious, they come from the province of Calmirixial in the western frontiers of Lyndhardtia. Before they were conquered in Naexidor’s campaign, Calmirixial was its own independent fiefdom, where the Drakian were the ultimate masters over their Zardman underlings due to their successful birth into the Drakian after being laid in the hatcheries. Those who would become Zardmen would be seen as nothing more than slave chattel to be used as expendable resources. As such, the Drakian and Zardman in Lyndhardtia naturally despise eachother, where Drakian’s who have Zardmen children often commit infanticide, and vice versa for the Zardmen. Due to this behavior the Drakian are very heavily disapproved of in Lyndhardtian society, and have been relegated to lower-end jobs and open hostilities at worst.<br>"
