/mob/living/simple_animal/hostile/retaliate/rogue/troll
	...
	name = "troll"
	desc = "Foul and hideous creatures that lurk in the swamps, bog trolls are a menace to any who dare to enter their territory. They are known for their immense strength and regenerative abilities, making them formidable foes."
	icon_state = "Troll"
	icon_living = "Troll"
	icon_dead = "Trolld"
	pixel_x = -16
