/datum/job/roguetown/wapprentice
	...
	tutorial = "Your master once saw potential in you, although you are uncertain if they still do, given your rigorous and difficult studies. The path to using magic is a treacherous and untamed one, and you are still decades away from calling yourself even a journeyman in the field. Listen and serve, and someday you will earn your hat."
