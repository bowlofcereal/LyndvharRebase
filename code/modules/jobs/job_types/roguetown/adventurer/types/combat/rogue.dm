/datum/advclass/rogue
	...
	traits_applied = list(TRAIT_OUTLANDER, TRAIT_GOODLOVER) //the biggest antags around.
...
/datum/outfit/job/roguetown/adventurer/rogue/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Treasure Hunter")
			...
			H.mind.adjust_skillrank(/datum/skill/craft/traps, 6, TRUE)
