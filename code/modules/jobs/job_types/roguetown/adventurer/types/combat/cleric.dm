...
/datum/outfit/job/roguetown/adventurer/cleric/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Missionary")
			...
			//Acolyte equivalent (since you can't play ascendant acolyte)
				C.grant_miracles(H, cleric_tier = CLERIC_T1, passive_gain = CLERIC_REGEN_MAJOR, devotion_limit = CLERIC_REQ_4)	
			else
			//Minor regen, capped to T3, same as post-nerf, for everyone else.
