...
/datum/outfit/job/roguetown/wretch/vigilante/pre_equip(mob/living/carbon/human/H)
	neck = /obj/item/clothing/neck/roguetown/chaincoif/full //So your skull isn't caved in if you decide to wear a cool hat. 
	...
	H.adjust_skillrank(/datum/skill/misc/tracking, 6, TRUE) //SNIFF OUT JUSTICE.
	H.cmode_music = 'sound/music/combat_maniac.ogg'
	var/classes = list("Watchman", "Gadgeteer", "Zadman")
...
/datum/outfit/job/roguetown/wretch/vigilante/proc/watchman_equip(mob/living/carbon/human/H)
	H.adjust_skillrank(/datum/skill/combat/unarmed, 1, TRUE) //No civilized barbarian. Sorry chud. Go play Berserker if you want that. 
