...
/datum/outfit/job/roguetown/wretch/outlaw/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/storage/belt/rogue/pouch/coins/poor = 1, /obj/item/lockpickring/mundane = 1, /obj/item/flashlight/flare/torch/lantern/prelit = 1, /obj/item/rope/chain = 1)
...
// Elven unique mercenary type; should be scary in a way solo but easy to kill with a group or bow. / Now a wretch subclass because it makes more sense.
/datum/advclass/wretch/blackoak
	name = "Black Oak"
	tutorial = "A shady guardian of the Black Oaks. Half mercenary band, half irregular militia fighting for control of their ancestral elven homeland of the Peaks."
	allowed_sexes = list(MALE, FEMALE)
	allowed_races = list(
