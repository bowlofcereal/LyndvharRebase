...
/datum/outfit/job/roguetown/masteratarms/polearms/pre_equip(mob/living/carbon/human/H)
	...
	H.mind.adjust_skillrank_up_to(/datum/skill/misc/athletics, 5, TRUE)	// We are basically identical to a regular MAA, except having better athletics to help us manage our order usage better
	H.mind.adjust_skillrank_up_to(/datum/skill/misc/riding, 3, TRUE)
	H.mind.adjust_skillrank_up_to(/datum/skill/misc/tracking, 2, TRUE)	//Decent tracking akin to Skirmisher.
