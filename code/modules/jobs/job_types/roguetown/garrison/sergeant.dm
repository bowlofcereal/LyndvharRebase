...
/datum/advclass/sergeant/sergeant
	...
	tutorial = "You are a not just anybody but the Sergeant-at-Arms of the City's garrison. While you may have started as some peasant or mercenary, you have advanced through the ranks to that of someone who commands respect and wields it. Take up arms, sergeant!"
