...
/datum/outfit/job/roguetown/builder/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/blacksmithing, 2, TRUE) //added to help with early round grind and so they can assist in making tools if needed.
