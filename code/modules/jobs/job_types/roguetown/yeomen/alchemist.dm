/datum/job/roguetown/alchemist
	...
	tutorial = "You came to Sundmark after hearing that there is a lack of potion-makers outside of the nobility. Stir up potions with your alchemy expertise--whether of health or death."
...
/datum/outfit/job/roguetown/alchemist/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		if(H.age == AGE_OLD)
			H.mind.adjust_skillrank_up_to(/datum/skill/craft/alchemy, 6, TRUE)
		else
			H.mind.adjust_skillrank_up_to(/datum/skill/craft/alchemy, 5, TRUE)
