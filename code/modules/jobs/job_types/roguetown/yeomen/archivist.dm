...
/datum/outfit/job/roguetown/archivist/pre_equip(mob/living/carbon/human/H)
	...
	H.adjust_skillrank(/datum/skill/language/elvish, 6, TRUE)
	H.grant_language(/datum/language/dwarvish)
	H.adjust_skillrank(/datum/skill/language/dwarvish, 6, TRUE)
	H.grant_language(/datum/language/celestial)
	H.adjust_skillrank(/datum/skill/language/sandspeak, 6, TRUE)
	H.grant_language(/datum/language/hellspeak)
	H.adjust_skillrank(/datum/skill/language/hellspeak, 6, TRUE)
	H.grant_language(/datum/language/orcish)
	H.adjust_skillrank(/datum/skill/language/orcish, 6, TRUE)
	H.grant_language(/datum/language/grenzelhoftian)
	H.adjust_skillrank(/datum/skill/language/grenzelhoftian, 6, TRUE)
	H.grant_language(/datum/language/otavan)
	H.adjust_skillrank(/datum/skill/language/otavan, 6, TRUE)
	H.grant_language(/datum/language/etruscan)
	H.adjust_skillrank(/datum/skill/language/etruscan, 6, TRUE)
