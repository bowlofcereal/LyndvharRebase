/datum/job/roguetown/niteman
	...
	tutorial = "You are renting out the bath-house in a joint operation with the Innkeep. You provide security for the bathwenches and help them to find work--when you're not being a trouble-making rake that others suffer to tolerate."
