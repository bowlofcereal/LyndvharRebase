...
/obj/item/clothing/suit/roguetown/armor/chainmail
	...
	armor = list("blunt" = 78, "slash" = 75, "stab" = 72, "bullet" = 20, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/plate
	...
	armor = list("blunt" = 70, "slash" = 80, "stab" = 80, "bullet" = 100, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/armordress
	...
	armor = list("blunt" = 70, "slash" = 68, "stab" = 73, "bullet" = 10, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/gambeson
	...
	icon_state = "gambeson"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS|VITALS
	armor = list("blunt" = 67, "slash" = 65, "stab" = 70, "bullet" = 15, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/gambeson/light
	...
	armor = list("blunt" = 65, "slash" = 63, "stab" = 67, "bullet" = 10, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/gambeson/heavy
	...
	armor = list("blunt" = 70, "slash" = 68, "stab" = 73, "bullet" = 20, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	sellprice = 30
...
//	color = "#514339"
	body_parts_covered = CHEST|GROIN|VITALS
	armor = list("blunt" = 72, "slash" = 70, "stab" = 75, "bullet" = 10, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	prevent_crits = list(BCLASS_CUT,BCLASS_BLUNT)
	blocksound = SOFTHIT
	blade_dulling = DULLING_BASHCHOP
	break_sound = 'sound/foley/cloth_rip.ogg'
...
/obj/item/clothing/suit/roguetown/armor/leather/studded
	...
	blocksound = SOFTHIT
	armor = list("blunt" = 72, "slash" = 70, "stab" = 75, "bullet" = 15, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/leather/vest
	...
	item_state = "vest"
	color = "#514339"
	armor = list("blunt" = 65, "slash" = 65, "stab" = 65, "bullet" = 5, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/silkcoat
	...
	icon_state = "bliaut"
	color = null
	armor = list("blunt" = 65, "slash" = 65, "stab" = 65, "bullet" = 7, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/roguetown/armor/blacksteel/platechest
	...
	icon_state = "bkarmor"
	item_state = "bkarmor"
	armor = list("blunt" = 72, "slash" = 82, "stab" = 82, "bullet" = 100, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	allowed_race = CLOTHED_RACES_TYPES
	nodismemsleeves = TRUE
	do_sound_plate = TRUE
	blocking_behavior = null
...
/obj/item/clothing/suit/roguetown/armor/brigandine/light
	...
	blocksound = SOFTHIT
	body_parts_covered = CHEST|GROIN|VITALS
	armor = list("blunt" = 69, "slash" = 77, "stab" = 77, "bullet" = 70, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	max_integrity = 350
	smeltresult = /obj/item/ingot/iron
	equip_delay_self = 40
	armor_class = ARMOR_CLASS_MEDIUM
