...
//	adjustable = CAN_CADJUST
	sewrepair = TRUE
	armor = list("blunt" = 60, "slash" = 60, "stab" = 60, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/under/roguetown/heavy_leather_pants
	...
	sewrepair = TRUE
	armor = list("blunt" = 72, "slash" = 70, "stab" = 75, "bullet" = 20, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/under/roguetown/splintlegs
	...
	max_integrity = 250
	armor = list("blunt" = 78, "slash" = 75, "stab" = 72, "bullet" = 60, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	prevent_crits = list(BCLASS_CUT, BCLASS_STAB, BCLASS_CHOP, BCLASS_BLUNT)
	blocksound = SOFTHIT
	drop_sound = 'sound/foley/dropsound/chain_drop.ogg'
...
/obj/item/clothing/under/roguetown/brayette
	...
	sewrepair = FALSE
	armor = list("blunt" = 78, "slash" = 75, "stab" = 72, "bullet" = 50, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	prevent_crits = list(BCLASS_CUT, BCLASS_STAB, BCLASS_CHOP, BCLASS_BLUNT)
	body_parts_covered = GROIN
	blocksound = CHAINHIT
	max_integrity = 300
...
//	adjustable = CAN_CADJUST
	sewrepair = FALSE
	armor = list("blunt" = 70, "slash" = 80, "stab" = 80, "bullet" = 50, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	prevent_crits = list(BCLASS_CUT, BCLASS_STAB, BCLASS_CHOP, BCLASS_BLUNT)
	blocksound = PLATEHIT
	max_integrity = 400
	var/do_sound = FALSE
...
/obj/item/clothing/under/roguetown/grenzelpants
	...
	detail_tag = "_detail"
	armor = list("blunt" = 65, "slash" = 65, "stab" = 65, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
//	adjustable = CAN_CADJUST
	sewrepair = FALSE
	armor = list("blunt" = 72, "slash" = 82, "stab" = 82, "bullet" = 50, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	prevent_crits = list(BCLASS_CUT, BCLASS_STAB, BCLASS_CHOP, BCLASS_BLUNT)
	blocksound = PLATEHIT
	max_integrity = 500
	var/do_sound = FALSE
