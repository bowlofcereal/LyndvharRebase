...
/obj/item/clothing/suit/roguetown/armor/brigandine
	...
	name = "brigandine"
	desc = "Composite armour made according to an Aevislan tradition. It's a high-quality arched plate cuirass sewn with dyed leather and fitted with a wide skirt at the bottom to cover the groin."
