...
/obj/item/fishingrod/aalloy
	...
	desc = "Abyssor drowned the world, long ago- while in battle with Dendor. The waves've long since receded, but Her greatest works remain shrouded far beneath the sea."
	icon_state = "arod"
	color = "#bb9696"
	sellprice = 15
