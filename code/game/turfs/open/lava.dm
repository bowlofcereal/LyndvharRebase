...
/turf/open/lava
	name = "lava"
	desc = "Thick viscous bubbles swell and burst with sprays of liquid rock. What was once locked away in the bowels of the earth now thrashes and gurgles on the surface, glowing with unimaginable heat. If you touch it, you will die."
	icon_state = "lava"
