...
/obj/item/rogueweapon/whip/antique/psywhip
	name = "Daybreak"
	desc = "Holding the blessed silver evokes a memory of the Grand Valorian Cathedral, a testament to humenity's faith. There, upon the ceiling, was painted a scene-most-beautiful: of a robed Psydon standing before the Archdaemon ZIZO, parting the nite's sky with a crack from His fiery whip. Just as He had done prior, so too must you bring daelight to the darkness."
	icon_state = "psywhip"
	is_silver = TRUE
