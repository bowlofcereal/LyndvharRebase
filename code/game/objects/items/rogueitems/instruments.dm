...
/obj/item/rogue/instrument/harp
	...
	"Vanesse Doth Watches" = 'sound/music/instruments/harb (3).ogg',
...
/obj/item/rogue/instrument/vocals
	...
	"Naime's Lullaby (Feminine)" = 'sound/music/instruments/vocalsf (2).ogg',
	"Death Touched the Gloam (Feminine)" = 'sound/music/instruments/vocalsf (3).ogg',
