...
/datum/patron/divine/noc
	...
	mob_traits = list(
	"t0" = list(TRAIT_NIGHT_OWL, TRAIT_NOCSIGHT))
...
/datum/patron/divine/dendor
	...
	mob_traits = list(
	"t0" = list(TRAIT_KNEESTINGER_IMMUNITY))
...
/datum/patron/divine/abyssor
	...
	mob_traits = list(
	"t0" = list(TRAIT_ABYSSOR_SWIM, TRAIT_SEA_DRINKER))
...
/datum/patron/divine/pestra
	...
	mob_traits = list(
	"t0" = list(TRAIT_EMPATH, TRAIT_ROT_EATER))
...
/datum/patron/divine/eora
	...
	mob_traits = list(
	"t0" = list(TRAIT_EMPATH, TRAIT_GOODLOVER))
	t0 = /obj/effect/proc_holder/spell/invoked/lesser_heal
