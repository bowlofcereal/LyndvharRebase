/datum/faith/divine
	name = "Elven Saints"
	desc = "The Hexarchy, six ancient elves purporting to be the original heirs of Anar and Isil, rulers of the now-lost Sun Elves.\n \n\
		...
		Human worship among the Tyrian Empire elevates these beings to the state of not only saints, but proper deities, capable of providing oracles. These 'gods' are ever-fickle to men, however, and often prayers seem unanswered."
