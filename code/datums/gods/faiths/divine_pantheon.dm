/datum/faith/divine
	...
	desc = "The TEN, children of PSYDON. The most accepted religion in Twilight Axis. born from Psydon sending the Comet Syon to defeat the rampaging Archdevil and splitting him into Ten. \n \n\
