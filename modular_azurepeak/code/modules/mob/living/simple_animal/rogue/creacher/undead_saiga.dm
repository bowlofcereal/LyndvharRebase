...
/mob/living/simple_animal/hostile/retaliate/rogue/saiga/undead/apply_damage(damage_amount, damage_type, def_zone, attack_type, armor_block_flags, sharp_pierce)
	. = ..()
	if(is_downed)
		if(def_zone == "head" || \
		   def_zone == "snout" || \
